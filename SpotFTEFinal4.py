...
def main():
    ...
    #data1 = pd.read_csv(r'C:\Users\RNA238\Downloads\df_fte_spot.csv')
    ...
    if(containersizein != None):
        ...
        html_temp = """
                    <h3 style  = "color:white;text-align:center;"> </h3>
                    <div style ">
                    <h4 style  = "color:black;text-align:center;background-color:#d7f5f9;">Try different slab rates and understand the impact on total revenue</h4>
                    <h5>   </h5>
                    </div>"""
        st.markdown(html_temp,unsafe_allow_html=True)
        ...
        if(st.button('Run Multiple Cannibalization')):
